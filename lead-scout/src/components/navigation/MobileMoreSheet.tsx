      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 max-h-[85vh] bg-card/95 backdrop-blur-2xl border-t border-border/50 rounded-t-3xl shadow-2xl flex flex-col overflow-hidden pb-[calc(1rem+env(safe-area-inset-bottom,0px))]"
          >
